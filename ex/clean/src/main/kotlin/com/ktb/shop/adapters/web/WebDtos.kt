...
// Web DTOs live in the adapters layer. They carry HTTP-specific concerns (validation,
// Swagger schema) and are mapped to/from the use-case boundary models in the controllers.
...
@Serdeable
@Schema(name = "CustomerResponse", description = "ลูกค้าที่สมัครสำเร็จ")
...
@Serdeable
@Schema(name = "ProductResponse", description = "สินค้าหนึ่งรายการในหมวดหมู่")
data class ProductResponse(
    ...
    @field:Schema(description = "ชื่อสินค้า", example = "Coffee Mug")
    val name: String,
    @field:Schema(description = "ราคาเป็นหน่วยสตางค์ (เลี่ยง floating point ของเงิน)", example = "19900")
    val priceCents: Long,
)
