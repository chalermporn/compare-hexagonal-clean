...
// Web DTOs — the HTTP wire shape, owned by the adapters layer. Deliberately
// separate from the use-case Input/Output models (the controller maps between
// them). Field limits mirror the Kotlin @NotBlank/@Size constraints.
