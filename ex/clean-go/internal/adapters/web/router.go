...
// NewRouter wires the controllers onto Go 1.22+ method-aware routes and
// wraps everything in the hardening middleware.
func NewRouter(customers *CustomerController, products *ProductController, db Pinger) http.Handler {
